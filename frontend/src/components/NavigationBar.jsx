        ...
        <div className="flex justify-around items-center py-3 px-2">
          <Link
            ...
            className={`flex flex-col items-center text-2xl transition-all duration-200 ${
              tab === "/"
                ? "text-transparent bg-clip-text bg-gradient-to-r from-fuchsia-400 to-cyan-300 scale-110"
                : "text-white/60 hover:text-white/90"
            }`}
          >
            <span>{tab === "/" ? <AiFillHome /> : <AiOutlineHome />}</span>
            {tab === "/" && <div className="w-1 h-1 rounded-full bg-gradient-to-r from-fuchsia-400 to-cyan-300 mt-0.5" />}
          </Link>
          <Link
            to={"/reels"}
          ...
          <Link
            ...
            className={`flex flex-col items-center text-2xl transition-all duration-200 ${
              tab === "/chat"
                ? "text-transparent bg-clip-text bg-gradient-to-r from-rose-400 to-pink-300 scale-110"
                : "text-white/60 hover:text-white/90"
            }`}
          >
            <span>
            ...
            {tab === "/chat" && <div className="w-1 h-1 rounded-full bg-gradient-to-r from-rose-400 to-pink-300 mt-0.5" />}
          </Link>
          <Link
